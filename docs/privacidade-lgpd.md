...
Tiflux segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Tiflux Sistema de Gestão** | BR | plataforma de help desk e service desk (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tiflux@mcp.ai](mailto:tiflux@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
